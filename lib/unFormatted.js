 ...
 */
var customArray = function (_Array) {
	...
	function customArray() {
		...
		var _this = _possibleConstructorReturn(this, (customArray.__proto__ || Object.getPrototypeOf(customArray)).call(this, size));
  ...
  */
   ...
   */
		...
		value: function extend() {
			...
			var array = this;
			if (!isNaN(length)) throw "length should be a number";else array.length = length;
