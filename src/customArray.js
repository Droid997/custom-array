  ...
  (function(_Array) {
    ...
    function customArray() {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(customArray).call(this, size)
      );
    ...
    _createClass(customArray, [
        ...
        value: function extend() {
          var length =
            arguments.length > 0 && arguments[0] !== undefined
              ...
              : this.length;
          var array = this;
          if (isNaN(length)) throw "length should be a number";
      ...
      },
      {
        ...
        value: function insertAt() {
          ...
          try {
            var array = this;
            if (typeof index == "string") throw "Index should be number";
            else {
              if (array.length < index) array.length = index;

              for (
                var _len2 = arguments.length,
                  items = new Array(_len2 > 1 ? _len2 - 1 : 0),
                  _key2 = 1;
                _key2 < _len2;
                _key2++
              ) {
      ...
      },
      {
        ...
        value: function registerEvent(event, fn) {
          ...
          try {
            ...
            else if (!fn) throw "Function Undefined";
            else {
              switch (event) {
                case "push":
